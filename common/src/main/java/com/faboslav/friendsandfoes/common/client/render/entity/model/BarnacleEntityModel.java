...
public final class BarnacleEntityModel<T extends BarnacleEntity> extends AnimatedEntityModel<T>
{
	...
	private static final String MODEL_PART_GRASS = "grass";
	private static final String MODEL_PART_GRASS_LEFT = "grass_left";
	private static final String MODEL_PART_GRASS_RIGHT = "grass_right";
	...
	private final ModelPart grassLeft;
	private final ModelPart grassRight;
	...
	public BarnacleEntityModel(ModelPart root) {
		...
		this.grass = this.body.getChild(MODEL_PART_GRASS);
		this.grassLeft = this.grass.getChild(MODEL_PART_GRASS_LEFT);
		this.grassRight = this.grass.getChild(MODEL_PART_GRASS_RIGHT);
	}
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData grass = body.addChild(MODEL_PART_GRASS, ModelPartBuilder.create().uv(0, 45).cuboid(-4.0F, -4.0F, 1.0F, 8.0F, 0.0F, 10.0F, new Dilation(0.0F))
			.uv(-6, 45).cuboid(-4.0F, 4.0F, 1.0F, 8.0F, 0.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -6.0F, 19.0F));
		grass.addChild(MODEL_PART_GRASS_LEFT, ModelPartBuilder.create().uv(-2, 45).cuboid(-10.0F, -4.0F, 20.0F, 8.0F, 0.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 6.0F, -19.0F, 0.0F, 0.0F, 1.5708F));
		grass.addChild(MODEL_PART_GRASS_RIGHT, ModelPartBuilder.create().uv(-4, 45).cuboid(2.0F, -4.0F, 20.0F, 8.0F, 0.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 6.0F, -19.0F, 0.0F, 0.0F, -1.5708F));
